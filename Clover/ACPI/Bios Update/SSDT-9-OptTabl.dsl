 ...
 *
 * Disassembly of SSDT-9-OptTabl.aml, Fri Jun  7 14:33:06 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001FD8 (8152)
 *     Revision         0x01
 *     Checksum         0x2A
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.STCC, MethodObj)    // 2 Arguments
    ...
    External (_SB_.PCI0.PEG0.PEGP.ICNV, MethodObj)    // 0 Arguments
    External (_SB_.PCI0.PEG0.PEGP.INIA, UnknownObj)
        ...
        PowerResource (PG00, 0x00, 0x0000)
        {
            ...
            Method (_ON, 0, Serialized)  // _ON_: Power On
            {
                If (LEqual (TDGC, One))
                {
                    ...
                    Store (Zero, TDGC) /* \_SB_.PCI0.PEG0.TDGC */
                    Store (Zero, DGCX) /* \_SB_.PCI0.PEG0.DGCX */
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        Method (GC6I, 0, Serialized)
        {
            ...
            Store (One, \_SB.PCI0.P0LD) /* External reference */
            Store (One, \_SB.PCI0.P0RM) /* External reference */
            Store (0x03, \_SB.PCI0.P0AP) /* External reference */
        ...
        {
            Store ("<<< GC6O >>>", Debug)
            Store (Zero, \_SB.PCI0.P0RM) /* External reference */
            Store (Zero, \_SB.PCI0.P0AP) /* External reference */
            Store (Zero, \_SB.PCI0.P0LD) /* External reference */
            If (LEqual (\_SB.GGIV (0x03010015), One))
            {
                \_SB.PCI0.SGPO (SGGP, Zero, 0x03010014, Zero, One)
                While (LNotEqual (\_SB.GGIV (0x03010015), Zero))
                {
                    Sleep (One)
                }

                \_SB.PCI0.SGPO (SGGP, Zero, 0x03010014, Zero, Zero)
            }
        ...
        Method (NGC6, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (One)
                {
                    ...
                    Store (One, GC6M) /* \_SB_.PCI0.PEG0.PEGP.NGC6.GC6M */
                ...
                Case (0x03)
                {
                    ...
                    Store (Arg3, TGPC) /* \_SB_.PCI0.PEG0.TGPC */
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x20)
                {
                    ...
                    {
                        Or (RET1, 0x00800000, RET1) /* \_SB_.PCI0.PEG0.PEGP.GPS_.RET1 */
                    }
                    ...
                    Switch (PSH0)
                    {
                        Case (Zero)
                        {
                            If (CPUT)
                            {
                                ...
                                Store (\_SB.PCI0.LPCB.EC0.ECPU, PDTS) /* \_SB_.PCI0.PEG0.PEGP.PDTS */
                        ...
                        Case (0x02)
                        {
                            ...
                            Store (\_SB.PCI0.LPCB.EC0.STCC (Zero, 0x27), TGPU) /* \_SB_.PCI0.PEG0.PEGP.TGPU */
